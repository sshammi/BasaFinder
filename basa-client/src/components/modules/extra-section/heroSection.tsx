...
export default function HeroSection() {
    return (
      <div className="flex flex-col items-center justify-center h-screen w-screen text-white bg-[#ff4b27ff] px-6 -mx-28">
        <h1 className="text-6xl font-extrabold text-center -mt-8">FIND YOUR NEXT HOME</h1>
